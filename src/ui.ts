/**
 * ui.ts — DOM helpers, icons, modals, toasts and a small JSON syntax
 * highlighter. Kept free of tokenpeek business logic.
 */
...
const ICONS = {
  clipboard: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>`,
  paste: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1"/></svg>`,
  ...
  key: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="7.5" cy="15.5" r="4.5"/><path d="m10.7 12.3 8.3-8.3"/><path d="m17 5 3 3"/><path d="m15 7 3 3"/></svg>`,
...
export function icon(name: keyof typeof ICONS, cls = ''): HTMLElement {
  ...
  const svg = wrapper.firstElementChild as HTMLElement;
...
export function toast(msg: string): void {
  ...
  toastTimer = window.setTimeout(() => toastEl?.classList.remove('visible'), 2000);
}

/** Copy text to the clipboard with a fallback, and toast the result. */
...
/** Return HTML with syntax-highlighted, indented JSON. Safe (escapes input). */
